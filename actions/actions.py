...
class ActionQueryKnowledgeBase(ActionQueryKnowledgeBase):
    """
    ...
    def __init__(self):
        ...
        # overwrite the representation function of the cafeteria object
        # by default the representation function is just the name of the object
        knowledge_base.set_representation_function_of_object(
           "cafeteria", lambda obj: obj["name"] #+ " (" + obj["bairro"] + ")"
        )
    ...
    def utter_attribute_value(
        ...
        if attribute_value:
            dispatcher.utter_message(
                text=f"{object_name}: {attribute_value}"
            )
        else:
            dispatcher.utter_message(
                text=f"Ops, não encontrei nada sobre '{attribute_name}' para '{object_name}'."
            )
    ...
    async def utter_objects(
        ...
        if objects:
            ...
            dispatcher.utter_message(
                text=f"Ops, não encontrei nada sobre isso."
            )
